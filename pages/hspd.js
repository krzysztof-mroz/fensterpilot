...
function HsPd() {
  ...
  return (
    ...
    <Fragment>
      <Head>
        <title>Fensterpilot salamander Premidoor 88</title>
        <meta name='description'
              content='salamander Hebe Schiebe Premidoor 88 visualisierung. 3d Visualisierung'
        />
         <meta name='keywords'
              content='fenster, kunststofffenster, fenster aus polen, salamander, hebe schiebe, hs, preimdoor'
        />
        <link rel="icon" href="/favicon.ico" />
      </Head>
      <HeaderDiv title="salamander Hebe Schiebe Türen" subtitle="Türsysteme, die Zugänglichkeit und Eleganz vereinen"/>
      <ProductVisualisation product="hspd" camera="48,48,48" productName="HS salamander Preimdoor 88"/>
      
      <div className="flex flex-wrap justify-around mb3 w-100 tc">
        <div className="w-100 w-40-l mt1 mt5-l">
        <h5 className="gray">salamander Premidoor 88</h5>
        ...
        <Image
        src={hsImage}
        alt="salamander Premidoor 88 Hebe Schiebe"
      />
        </div>
      </div>
