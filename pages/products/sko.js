...
function Sko() {
  ...
  return (
    ...
    <Fragment>
      <Head>
        <title>Fensterpilot Vorsatzrollladen SKO</title>
        <meta name='description'
              content='Aluprof Vorsatzrollladen SKO halbrund. 3d Visualisierung'
        />
         <meta name='keywords'
              content='rollladen, vorsatzrollladen aus polen, aluprof, sko, halbrund'
        />
